      ...
      <div className=''>
        ...
        <div className="flex justify-center">
          <div className="w-4xl">
            ...
            <div className="p-2">
              <div className="bg-gray-300 mb-2 flex justify-between p-2 font-bold">
                <div className='flex'>
                  ...
                  return (
                    <div className='bg-gray-200 mb-2 p-3' key={index}>
                      ...
                      <div className='text-end'>
                        <p className='mr-10 flex justify-between mb-1 font-bold'><span className='mr-5'>Total Amount :  </span><span>{order.amount}</span></p>
